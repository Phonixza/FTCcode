...
public class AutonomousR extends LinearOpMode {
    ...
    private static final double TARGET_VELOCITY = 2130;
    private final double[] CONVEYER_POSITIONS_DEG = {15, 58.0, 106.0};
    private static final double SHOOTING_REST_DEG = 150.0;
    private static final double SHOOTING_FIRE_DEG = 255.0;
    ...
    public void runOpMode() {
        ...
        servo_angle.setPosition(0.0); // ตั้งค่ามุมเริ่มต้นสำหรับ Auto
    ...
    public void shoot(int Lo) {
        ...
        telemetry.update();
        sleep(1700); // รอให้มอเตอร์ได้ความเร็ว
        ...
        sleep(300); // รอให้ servo ยิงเสร็จ
        servo_shooting.setPosition(degToServo270(SHOOTING_REST_DEG));
